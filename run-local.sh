...
# Create workspace directories (persistent: user configs/autosaves/custom profiles)
...
# Create tmp directories (ephemeral: session uploads, job outputs, sqlite db)
mkdir -p $TMP_ROOT/sessions
